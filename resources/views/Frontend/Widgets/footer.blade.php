<section id="sectionHomeStore" class="clearfix">
    <div class="padding-rl-40">
      <div class="innerHomeStore">
        <div class="contentHomeStore">
          <div class="textStore">
            <a href="/blogs/he-thong-cua-hang?itm_source=ftr&amp;itm_campaign=normal&amp;itm_content=showroom" title="Xem địa chỉ hệ thống 81 Showroom!"
              >Xem địa chỉ hệ thống 81 Showroom!</a
            >
          </div>
        </div>
      </div>
      ...
      <div class="innerInfoFooter clearfix">
        <div class="col-xs-12 col-sm-3">
          ...
          <div class="infoContent">
            <p>
              <span class="iconFooter"><i class="icofont-phone"></i></span>
        ...
        <div class="col-xs-12 col-sm-3 site-animation">
          <h4>ĐĂNG KÝ NHẬN THÔNG TIN MỚI TỪ JUNO</h4>
          <div id="mc_embed_signup" class="newsletter-form">
            ...
            >
              <div id="mc_embed_signup_scroll">
                <input type="hidden" name="custom_source" value="ĐĂNG KÝ NHẬN THÔNG TIN MỚI TỪ JUNO" />
                <input type="hidden" name="campaign_token" value="xx" />
        ...
        <div class="col-xs-12 col-sm-3 site-animation">
          ...
          <ul class="navbar-social">
            ...
            <li>
              <a href="https://www.tiktok.com/@giaytuijuno?lang=en" target="_blank" rel="nofollow">
        ...
        <div class="col-xs-12 col-sm-3">
          ...
          <ul>
            <div
              ...
              data-href="https://www.facebook.com/giayjuno"
              data-tabs
              data-width
              data-height
    ...
    <div class="wrapper-new">
      <div class="row">
        <div class="col-xs-12 col-sm-8">
          <div class="desBottom">
            2019 JUNO. Công ty CP-SX-TM-DV Juno. Số ĐKKD: 0310350452. Đăng kí lần đầu: Ngày 13 tháng 10 năm 2010. Đăng kí thay đổi lần thứ: 19, ngày 11
            tháng 06 năm 2020. Nơi cấp: Sở Kế Hoạch và Đầu Tư Thành Phố Hồ Chí Minh - Phòng Đăng Kí Kinh Doanh. Địa chỉ liên hệ: 313 Nguyễn Thị Thập,
            phường Tân Phú,quận 7. SĐT: 18001160
          </div>
        </div>
        <div class="col-xs-12 col-sm-4">
          <div class="imgBottom">
            <a href="http://online.gov.vn/Home/WebDetails/69624" target="_blank">
              <img src="{{asset('frontend/images/icon-dangky_ed795de8b131419393b256f6384de715.png')}}" />
            </a>
            <p>Powered by <a target="_blank" href="https://www.haravan.com/?hchan=juno">Haravan Enterprise.</a></p>
          </div>
        </div>
      </div>
    </div>
