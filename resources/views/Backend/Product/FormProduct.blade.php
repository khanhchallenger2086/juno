        ...
        <div class="form">
            <form class="pt-4 pb-4 cmxform form-horizontal" method="post" action="{{$action}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="custom-file">
                            ...
                            <input type="file" class=" custom-file-input" name="image_main[]" multiple id="inputGroupFile01"
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input class="form-control" type="text" value="{{ isset($product) ? $product->style : "" }}" name="style"
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input class="form-control" type="text" value="{{ isset($product) ? $product->material : "" }}" name="material"
                        ...
                        <ul style="list-style-type:none">
                            ...
                            <li><a href="">
                                    <label for="checkbox{{$item->id}}">
                                        ...
                                        explode(";",$product->id_category))) checked @endif @endif id="checkbox{{$item->id}}" name="id_category[]">
                                        {{$item->name}}
                                    </label>
                                </a>
                                ...
                                <ul style="list-style-type:none" class="ml-4">
                                    ...
                                    <li><a href="">
                                            <label for="checkbox{{$item_son->id}}">
                                                <input type="checkbox" value="{{$item_son->id}}" @if (isset($product)) @if (in_array((string)
                                                    $item_son->id,
                                                explode(";",$product->id_category))) checked @endif @endif id="checkbox{{$item_son->id}}"
                                                name="id_category[]">
                                                {{$item_son->name}}
                                            </label>
                                    </li>
