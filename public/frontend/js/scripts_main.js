...
var juno = {
	init: function() {
		...
		if(window.shop.template == 'collection.ldp-juno-june'){
			this.June2020.init();
		}
	},
}
		...
		$(".checkLimitCart").click(function(e){
			...
			$.ajax({
				...
				success: function(data){
					...
					getAtt['trackingId'] = (trackingId != null) ? trackingId : 'null';
					getAtt['userId'] = (userId != null) ? userId : 'null';
					getAtt['cliendid'] = (cliendid != null) ? cliendid : 'null';
...
juno.WalkFreely = {
	...
	slideStar: function(){
		$('.sliderStar .owl-carousel').owlCarousel({
			items:1,
			nav: true,
			navText : ["<img src='//theme.hstatic.net/1000003969/1000574762/14/left-arrow-white.png?v=883' alt='Left Arrow' />","<img src='//theme.hstatic.net/1000003969/1000574762/14/right-arrow-white.png?v=883' alt='Right Arrow' />"],
			dots: false,
			touchDrag: true,
		});
	},
...
juno.LdpSeptember = {
	...
	countDownSeptember: function(){
		$(".countDownCampaign .lof-clock-detail").lofCountDown({
			TargetDate:"06/26/2020 23:59:59",
			DisplayFormat:"<ul class='list-inline'><li class='day'>%%D%%<span>ngày</span></li><li>%%H%%<span>giờ</span></li><li>%%M%%<span>phút</span></li><li>%%S%%<span>giây</span></li></ul>",
			FinishMessage: "Hết hạn"
		});
	},
